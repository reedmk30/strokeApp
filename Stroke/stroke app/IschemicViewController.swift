...
class IschemicViewController: UIViewController {
    ...
    @IBOutlet var viewForDescriptionLabel: UIView!
    ...
    override func viewDidLoad() {
        ...
        viewForDescriptionLabel.backgroundColor = UIColor.red   
